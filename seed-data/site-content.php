...
return [
    ...
    'et_homepage_settings' => [
        ...
        'section_order'                => '["intro","offers","bespoke-journeys","process","experiences","testimonials","founder-cta"]',
        'section_bespoke-journeys_visible' => '1',
        // Bespoke Journeys section copy, admin-editable via Homepage admin if added there.
        'bespoke_journeys_eyebrow'     => 'Bespoke Journeys',
        'bespoke_journeys_heading'     => 'Two Ways to Travel.',
        'bespoke_journeys_subhead'     => 'Same level of care, same private hosting, same end-to-end design, across either eleven to fifteen days, or six to ten. Choose your length and we build the rest around you.',
    ],
    ...
    'et_regions' => [
        ...
        [
            ...
            'image_filename' => 'kinsale-charles-fort-harbour.jpg',
            'image_id'       => 0,
        ...
        [
            ...
            'image_filename' => 'kerry-ring-mountains-lake.jpg',
            'image_id'       => 0,
            'tour_link_text' => 'Featured in: Signature, Essence & Bespoke',
            'tour_link_url'  => '/experiences/signature-ireland-journey/',
        ],
        ...
        [
            ...
            'image_filename' => 'galway-long-walk-houses.jpg',
            'image_id'       => 0,
    ...
    // ── Sample Itineraries, DEPRECATED (was et_itineraries) ─────
    // The Experience CPT (now labelled "Sample Itineraries") replaces this
    // option. Seeder writes [] so any historical data on live is cleared.
    // Front-end templates that previously read this option (sample-itinerary
    // sections on /bespoke-tours/ and /golf-tours/) have been removed.
    'et_itineraries' => [],
    ...
    'et_key_experiences' => [
        ...
        [ 'name' => 'Charles Fort',                  'region' => 'Co. Cork',           'desc' => 'A 17th-century star-shaped fort on the Kinsale headland, with sweeping views of the harbour mouth.',                                                                                       'image_filename' => 'charles-fort-kinsale.jpg',     'image_id' => 0, 'url' => '' ],
        ...
        [ 'name' => 'Sheen Falls',                   'region' => 'Kenmare, Co. Kerry', 'desc' => 'Waterfall, lodge, and a quiet riverside walk before crossing into the Ring of Kerry.',                                                                                                    'image_filename' => 'sheen-falls-kerry.jpg',        'image_id' => 0, 'url' => '' ],
        [ 'name' => 'Ring of Kerry',                 'region' => 'Co. Kerry',          'desc' => 'The classic Kerry loop, done at the right pace, in the right direction, stopping where the buses do not.',                                                                              'image_filename' => 'ring-of-kerry-cliffs.jpg',     'image_id' => 0, 'url' => '' ],
        ...
        [ 'name' => "Daniel O'Connell & Derrynane",  'region' => 'Co. Kerry',          'desc' => "The Liberator's family home and the Atlantic strand below it, a personal walk through 19th-century Irish history.",                                                                     'image_filename' => 'derrynane-kerry-coast.jpg',    'image_id' => 0, 'url' => '' ],
        [ 'name' => 'Slea Head Drive',               'region' => 'Dingle, Co. Kerry',  'desc' => 'The Dingle Peninsula loop, beehive huts, sea cliffs, the mainland edge of Europe.',                                                                                                       'image_filename' => 'slea-head-cliffs.jpg',         'image_id' => 0, 'url' => '' ],
        [ 'name' => 'Dingle Peninsula',              'region' => 'Co. Kerry',          'desc' => "Cinematic, atmospheric, and full of character, Ray's favourite stretch of Ireland.",                                                                                                      'image_filename' => 'dingle-peninsula-cliffs.jpg',  'image_id' => 0, 'url' => '' ],
        ...
        [ 'name' => "Foxy John's pub",               'region' => 'Dingle, Co. Kerry',  'desc' => 'Half pub, half hardware shop, pull a Guinness, buy a hammer. The kind of evening you cannot plan.',                                                                                      'image_filename' => 'foxy-johns-pub-corner.jpg',    'image_id' => 0, 'url' => '' ],
        ...
        [ 'name' => 'Black Taxi political tour',     'region' => 'Belfast',            'desc' => "A privately hosted black-taxi tour through the murals and the history, a powerful, unflinching introduction to the city's past.",                                                          'image_filename' => 'belfast-bittles-bar.jpg',      'image_id' => 0, 'url' => '' ],
